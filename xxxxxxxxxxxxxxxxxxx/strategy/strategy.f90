...
module strategy_mod
    ...
    type, abstract :: data_t
        contains
            procedure(get_values_abstract) :: get_values_abstract
    end type data_t
...
contains
    ...
    function get_values_real(this)
        ...
        real(8), dimension(:,:,:,:), pointer :: get_values_real
    ...
    !     integer, dimension(:,:,:,:), pointer :: get_values_integer
